...
val shack = new Area("Run Down Shack", "A dilapidated cabin. You see a hole in the floor and a ladder leading down.")
val underground1 = new Area("Underground Tunnel", "You see a ladder and a neverending tunnel which has no end in sight.")
val underground2 = new Area("Underground Tunnel", "You are standing in a tunnel which streches on and on in two directions. There is a ladder leading up from where you're standing.")
val underground3 = new Area("Underground Tunnel", "An underground tunnel with a door on one side and infinite darkness on the other.")
val westernEnd = new Area("Western End of the Yard", "A simple looking area at the far-western end of the yard.")
val backEntrance = new Area("Back Entrance", "A back entrance with delivery men and other workers unloading boxes. There is no end in sight for their workload.")
val storageRoom = new Area("Storage Room", "A room with plenty of shelves and boxes. There appears to be a separate corner for refrigerated content.")
val kitchen = new Area("Kitchen", "There are chefs noisily shuffling about.")
val bar = new Area("Bar", "A counter behind which are two bartenders and dozens of bottles.")
val wc = new Area("WC", "A nice looking area with five stalls and sinks.")
val toiletRoom = new Area("Toilet Room", "A simple looking stall. Nobody will disturb you here.")
val ballroomNorth = new Area("Ballroom", "The end of the ballroom. On one side is a bar, on the other the WC. There are guests all around you.")
val ballroomSouth = new Area("Ballroom", "An enormous ballroom which continues on and on. There are guests all around you.")
val entrance = new Area("Entrance", "The main entrance of the building. To the west is a guarded door, to the east the ballroom and main party.")
val hallway = new Area("Hallway", "A hallway leaging to a staircase, the kitchen, and the main entrance. You best hurry up before anybody notices you.")
val stairs = new Area("Staircase", "A cicrular stairway leading up and down.")
val wineCellar = new Area("Wine Cellar", "You see wine barrels all around you. Behind some of the barrels appears to be a door.")
...
val hallway2nd = new Area("Hallway", "To the west is a toilet and to the east a children's playroom.")
val toilet2nd = new Area("Toilet", "A simple looking room with a toilet and sink.")
val playroom = new Area("Playroom", "A children's playroom. Presumably for any children visitors may have.")
val childroom = new Area("Bedroom", "This bedroom appears to belong to small child. Presumably the target's son. You see a window to the north and two doors.")
val bathroom = new Area("Bathroom", "The bathroom has a shower, a bath, a sink and a toilet. Everything in here looks fairly new.")
val bedroom = new Area("Bedroom", "The target's bedroom. It has surprisingly simple furnishing and looks quite plain. When looking out the eastern window you notice a porch roof which you could probably safely jump down to.")
val workroom = new Area("Workroom", "A nice looking room with basic office tools and a computer.")
